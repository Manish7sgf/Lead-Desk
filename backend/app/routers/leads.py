...
def format_lead(lead_dict: dict) -> dict:
    ...
    return {
        ...
        "project_type": lead_dict.get("project_type", "Full-Stack Web App"),
        "timeline": lead_dict.get("timeline", "Flexible"),
...
async def create_lead(lead: LeadCreate):
    ...
    new_lead_doc = {
        ...
        "project_type": lead.project_type or "Full-Stack Web App",
